export default function Servicio3() {
  return (
    <div>
      ...
      >
        ...
        <div className="container" style={{ position: 'relative', zIndex: 2, textAlign: 'center' }}>
          <h1 style={{ color: 'white', marginBottom: '12px' }}>Servicio 3</h1>
          ...
          <div className="row">
            <div className="col-lg-8 mx-auto">
              ...
              <div style={{ marginTop: '32px', marginBottom: '32px' }}>
                <img 
                  src="https://via.placeholder.com/600x300?text=Servicio+3" 
                  className="img-fluid rounded" 
                  alt="Servicio 3"
                  style={{ width: '100%', height: 'auto' }}
                />
                <small style={{ color: 'var(--gray-500)', display: 'block', marginTop: '8px' }}>
                  {/* CAMBIAR ESTA IMAGEN: reemplaza /path-to-servicio3-image.jpg con tu imagen */}
                </small>
              </div>
